...
async function Consultar() {
    ...
    try {
        const Respuesta = await fetch("http://localhost/PHP_PROJECT/Controllers/CategoriaController.php=" + Codigo,
            {
                method: "GET",
                mode: "cors",
                headers: {
...
async function EjecutarComandos(Comando) {
    ...
    //Invocamos el servicio a través del fetch, usando el método fetch de javascript
    try {
        const Respuesta = await fetch("http://localhost/PHP_PROJECT/Controllers/CategoriaController.php",
            {
                method: Comando,
                mode: "cors",
                headers: {
